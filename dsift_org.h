...
extern double sift_time;
extern double kernel_time, copy_time, filt_time, wait_time, init_time;
...
VL_EXPORT void my_vl_dsift_process (VlDsiftFilter *self, float const* im, float scale, int with_gpu) ;
//VL_EXPORT void my_vl_dsift_process_gpu (VlDsiftFilter *self, float const* im, float* siftresg) ;
VL_EXPORT void my_vl_dsift_process_gpu (VlDsiftFilter* self, float const* im, float scale, int offset, int firstflag, int lastflag, int total, float* dst, float* siftframe, int scaleindex);
